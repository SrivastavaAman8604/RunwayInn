...
<head>
    ...
    <title>The Runway Inn Luxury Hotel</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container">
            ...
            <div class="logo-wrapper">
                <a class="logo" href="index-2.html"> <img src="img/runnway.png" class="logo-img" alt=""> </a>
            ...
            <div class="collapse navbar-collapse" id="navbar">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item dropdown"> <a class="nav-link active dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">Home 
                    ...
                    <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">Rooms & Suites 
                        <!-- <i class="ti-angle-down"></i> -->
                    </a>
                        <!-- <ul class="dropdown-menu">
                    ...
                    <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">Pages 
                        <!-- <i class="ti-angle-down"></i> -->
                    </a>
                        <!-- <ul class="dropdown-menu">
    ...
    <header class="header slider-fade">
        <div class="owl-carousel owl-theme">
            ...
            <div class="text-center item bg-img" data-overlay-dark="2" data-background="img/slider/banner-2.jpg">
            ...
            <div class="text-center item bg-img" data-overlay-dark="2" data-background="img/slider/banner-1.jpg">
                <div style="background-color: rgba(0, 0, 0, 0.2);">
                    <div class="v-middle caption">
                        <div class="container">
                            <div class="row">
            ...
            <div class="text-center item bg-img" data-overlay-dark="3" data-background="img/slider/banner-3.jpg">
                <div style="background-color: rgba(0, 0, 0, 0.2);">
                    <div class="v-middle caption">
                        <div class="container">
                            <div class="row">
        ...
        <div class="reservation">
            <a href="tel:93058 04900">
                ...
                <div class="call"><span>93058 04900</span> <br>Reservation</div>
            </a>
        </div>
    </header>
    <!-- About -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 mb-30 animate-box" data-animate-effect="fadeInUp">
                    ...
                    <div class="section-subtitle">The Runway Inn Luxury Hotel</div>
                    <div class="section-title">Enjoy a Luxury Experience</div>
                    <p>Hotel Runway Inn is conveniently located just outside Lal Bahadur Shastri International Airport, Varanasi and is well suited to business and leisure travelers. Guests return to the upscale furnishings found in our contemporary rooms and suites, after a busy day and take time to indulge in our world class amenities and services.</p>
                    <p>Sleek style, plush furnishings and modern decor combine to create an unforgettable stay at Hotel Runway Inn. Each of our 31 contemporary designed well-appointed rooms and suites offer incredible views.Enjoy all conveniences and select from Economy, Premium Economy, Business Class and Maharaja Suite. Enjoy our roof top Swimming Pool with Green lawns and indulge in the open dining area, relishing the ambience & beauty.</p>
                    <!-- call -->
                ...
                <div class="row">
                    <div class="col-md-8 offset-md-2 text-center">
                       <span><i class="star-rating"></i><i class="star-rating"></i><i class="star-rating"></i><i class="star-rating"></i><i class="star-rating"></i></span>
                        <div class="section-subtitle"><span>The Runway Inn Luxury Hotel</span></div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="single-facility animate-box" data-animate-effect="fadeInUp">
                        ...
                        <h5>Room Service</h5>
                        <p>The hotel Runway Inn offers efficient room service for a comfortable and enjoyable stay.</p>
                ...
                <div class="col-md-4">
                    <div class="single-facility animate-box" data-animate-effect="fadeInUp">
                        ...
                        <h5>Swimming Pool</h5>
                        <p>Enjoy a refreshing escape with our inviting swimming pool, offering a perfect blend of relaxation and leisure at our hotel.</p>
                ...
                <div class="col-md-4">
                    <div class="single-facility animate-box" data-animate-effect="fadeInUp">
                        ...
                        <p>The hotel offers high-speed fiber internet services for seamless and fast connectivity during your stay.</p>
                ...
                <div class="col-md-4">
                    <div class="single-facility animate-box" data-animate-effect="fadeInUp">
                        ...
                        <h5>Breakfast</h5>
                        <p>Indulge in the culinary delights of a multicuisine casual dining restaurant </p>
                ...
                <div class="col-md-6 p-0 bg-cream valign animate-box" data-animate-effect="fadeInRight">
                    <div class="content">
                        <div class="cont text-left">
                            ...
                            <p>A Multicuisine Casual Dining Restaurant.Fresh and exciting multi-cuisine takes centre stage here with 55-60 Cover, Full Day Dining with nice ambience just outside Varanasi Airport.</p>
                ...
                <div class="col-md-6 bg-cream p-0 order2 valign animate-box" data-animate-effect="fadeInLeft">
                    <div class="content">
                        <div class="cont text-left">
                            ...
                            <h4>Spa Center</h4>
                            <p>Indulge in relaxation and rejuvenation with our luxurious Spa Center services, offering a serene escape for your mind and body.</p>
                ...
                <div class="col-md-6 p-0 bg-cream valign animate-box" data-animate-effect="fadeInRight">
                    <div class="content">
                        <div class="cont text-left">
                            ...
                            <p>The hotel offers a well-equipped fitness center to cater to the health and wellness needs of its guests.</p>
                            <div class="butn-dark"> <a href="/"><span>Learn More</span></a> </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 bg-cream p-0 order2 valign animate-box" data-animate-effect="fadeInLeft">
                    <div class="content">
                        <div class="cont text-left">
                            ...
                            <p>For a sophisticated time, head here. It's perfect for meetings between business partners, colleagues and friends. Explore the roof top pool with lounge, at Level-3 along with wooden deck floor and lavish garden, with sitting for approx 40-45 pax, amidst a half covered and hald open ambience. Enjoy as you relax.</p>
                            <div class="butn-dark"> <a href="/"><span>Learn More</span></a> </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-5 mb-30 mt-30">
                        ...
                        <div class="reservations mb-30">
                            ...
                            <div class="text">
                                <p class="color-1">Reservation</p> <a class="color-1" href="tel:855-100-4444">93058 04900</a>
                            </div>
                        </div>
                    ...
                    <div class="col-md-5 offset-md-2">
                        <div class="booking-box">
                            ...
                            <div class="booking-inner clearfix">
                                <form action="https://duruthemes.com/demo/html/Runway Inn/demo2-light/rooms2.html" class="form1 clearfix">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="input1_wrapper">
                                                <label>Check in</label>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="footer-column footer-about">
                            ...
                            <p class="footer-about-text">We are the only Hotel Option at Varanasi Airport for frequent travelers who wish to stay overnite and catch Flight to there Destination from Varanasi and vice-versa.</p>
                    ...
                    <div class="col-md-4">
                        <div class="footer-column footer-contact">
                            ...
                            <p class="footer-contact-text">16 GH, Babatpur LBS International Airport<br>Varanasi - 221 006 (U.P.), India</p>
                            <div class="footer-contact-info">
                                <p class="footer-contact-phone"><span class="flaticon-call"></span> 93058 04900</p>
                                <p class="footer-contact-mail">info@hotelrunwayinn.com</p>
                            </div>
...
<!-- Mirrored from duruthemes.com/demo/html/Runway Inn/demo2-light/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 23 Jan 2024 10:02:15 GMT -->
</html>