...
<!-- Mirrored from duruthemes.com/demo/html/cappa/demo2-light/index2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 23 Jan 2024 10:02:19 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container">
            ...
            <div class="logo-wrapper">
                <a class="logo" href="index-2.html"> <img src="img/logo.png" class="logo-img" alt=""> </a>
                ...
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item dropdown"> <a class="nav-link active dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">Home <i class="ti-angle-down"></i></a>
                        <ul class="dropdown-menu">
                            <li><a href="index-2.html" class="dropdown-item"><span>Home Layout 1</span></a></li>
                            <li><a href="index2.html" class="dropdown-item active"><span>Home Layout 2</span></a></li>
...
<!-- Mirrored from duruthemes.com/demo/html/cappa/demo2-light/index2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 23 Jan 2024 10:02:20 GMT -->
</html>